...
class Inception20(nn.Module):
    def __init__(self):
        ...
        # output  size is 32
        self.conv2_x1 = nn.Conv2d(16, 16, kernel_size=3, stride=1, padding=1)
        self.bn2 = nn.BatchNorm2d(16)

        self.conv2_x2 = nn.Conv2d(16, 32, kernel_size=3, stride=2, padding=1)
        self.bn3 = nn.BatchNorm2d(32)

        # output size is 16
        self.conv3_x1 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1)
        self.bn4 = nn.BatchNorm2d(32)

        self.conv3_x2 = nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1)
        self.bn5 = nn.BatchNorm2d(64)

        # output size is 8
        self.conv4_x1 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
